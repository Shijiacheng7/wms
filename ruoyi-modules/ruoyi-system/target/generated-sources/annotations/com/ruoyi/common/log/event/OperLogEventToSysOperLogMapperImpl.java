...
@Component
public class OperLogEventToSysOperLogMapperImpl implements OperLogEventToSysOperLogMapper {

    @Override
    public SysOperLog convert(OperLogEvent arg0) {
        if ( arg0 == null ) {
            return null;
        }
        ...
        if ( arg0.getOperTime() != null ) {
            sysOperLog.setOperTime( LocalDateTime.ofInstant( arg0.getOperTime().toInstant(), ZoneId.of( "UTC" ) ) );
        }
    ...
    @Override
    public SysOperLog convert(OperLogEvent source, SysOperLog target) {
        if ( source == null ) {
            return target;
        }
