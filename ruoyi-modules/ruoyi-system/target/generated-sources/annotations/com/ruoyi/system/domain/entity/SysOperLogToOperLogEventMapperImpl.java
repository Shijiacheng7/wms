...
@Component
public class SysOperLogToOperLogEventMapperImpl implements SysOperLogToOperLogEventMapper {

    @Override
    public OperLogEvent convert(SysOperLog arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public OperLogEvent convert(SysOperLog source, OperLogEvent target) {
        if ( source == null ) {
            return target;
        }
