...
@Generated(
    ...
    date = "2026-03-06T21:50:26+0800",
    comments = "version: 1.5.5.Final, compiler: javac, environment: Java 17.0.2 (Oracle Corporation)"
)
@Component
public class InventoryBoToInventoryMapperImpl implements InventoryBoToInventoryMapper {

    @Override
    public Inventory convert(InventoryBo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public Inventory convert(InventoryBo source, Inventory target) {
        if ( source == null ) {
            return target;
        }
