...
@Component
public class ReceiptOrderDetailBoToInventoryMapperImpl implements ReceiptOrderDetailBoToInventoryMapper {

    @Override
    public Inventory convert(ReceiptOrderDetailBo arg0) {
        if ( arg0 == null ) {
            return null;
        }
    ...
    @Override
    public Inventory convert(ReceiptOrderDetailBo source, Inventory target) {
        if ( source == null ) {
            return target;
        }
